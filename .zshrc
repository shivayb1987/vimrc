...
# Exports {{{
export GITHUB_USER="shivayb1987@gmail.com"
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:$HOME/Library/Python/3.7/bin # Reorder PATH so local bin is first
...
function prompt_char {
  ...
  hg root >/dev/null 2>/dev/null && echo 'pg19.jpg' && return
  echo 'pg19a.jpg'
}
...
# alias nvim to nvr in terminal buffer
if [ -n "$NVIM_LISTEN_ADDRESS" ]; then
